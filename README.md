...
3. [The Avatar — Legendary Hero](#the-avatar--legendary-hero)
4. [Multi-Agent AI Orchestrator](#multi-agent-ai-orchestrator)
5. [NPC Mood & Personality System](#npc-mood--personality-system)
6. [Hireling Command System](#hireling-command-system)
7. [Harvest Subagent (Mining / Lumberjacking)](#harvest-subagent-mining--lumberjacking)
8. [Faction System Overhaul](#faction-system-overhaul)
9. [Sea Battles & Naval Encounters](#sea-battles--naval-encounters)
10. [Sailor Hirelings & Boat Automation](#sailor-hirelings--boat-automation)
11. [AI Quest & Reputation Integration](#ai-quest--reputation-integration)
12. [All AI Inference Backends Supported](#all-ai-inference-backends-supported)
